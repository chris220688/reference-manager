			...
			<Container className="responsive-text" style={{"marginTop": "20px"}}>
				...
				<div>
					...
					<ul>
						...
						<li>
							<p>
								8.4 {this.props.domainName} is a participant in affiliate advertising programs, such as the Amazon Services LLC Associates program, the Waterstones and the BookDepository affiliates program.
							</p>
							<p>
